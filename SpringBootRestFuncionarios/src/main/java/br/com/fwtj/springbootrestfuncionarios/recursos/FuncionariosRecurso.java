...
public class FuncionariosRecurso {
    ...
    public ResponseEntity<Falta> salvarFalta(@PathVariable Long idFuncionario, @Valid @RequestBody Falta falta) {
        ...
        return ResponseEntity.created(uri).header("Resposta", falta.getRespostaAPI()).body(falta);
    }
